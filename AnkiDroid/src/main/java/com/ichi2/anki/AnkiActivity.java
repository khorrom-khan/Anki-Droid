...
public class AnkiActivity extends AppCompatActivity implements SimpleMessageDialog.SimpleMessageDialogListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ContextCompat.checkSelfPermission(AnkiActivity.this,
    ...
    protected void onStop() {
        ...
        String coverageFilePath = "/mnt/sdcard/AnkiDroid/coverage.exec";

        //String coverageFilePath = Environment.getExternalStorageDirectory() + File.separator+ "coverage.ec";
